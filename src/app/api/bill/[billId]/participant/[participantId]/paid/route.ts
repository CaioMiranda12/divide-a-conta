...
import { setParticipantPaidStatus } from '@/services/participant/setParticipantPaidStatus';
import { setParticipantPaidSchema } from '@/schemas/participant';
...
export async function PATCH(
  ...
  const parsedBody = setParticipantPaidSchema.safeParse(body);
  ...
  try {
    ...
    await setParticipantPaidStatus({
      billId,
      participantId,
      currentUserId: currentUser.id,
      hasPaid: parsedBody.data.hasPaid,
    });
